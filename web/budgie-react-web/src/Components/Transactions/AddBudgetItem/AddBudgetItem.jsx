...
export default function AddBudgetItem(props) {
  ...
  return (
    <div className="add-transaction-form-container">
      ...
      >
        <div>
          <label htmlFor="transactionDollarAmount">
            Enter dollar amount of transaction:
          </label>

          <div className="input-container money-input">
            {props.income ? "" : "-"}${" "}
            <input
              type="number"
        ...
        <div>
          <label htmlFor="transactionNote">
            Set a note for the transaction:
          </label>
        ...
        <div className="form-button-container ui-icon-toolbar">
          <Tooltip text="Clear">
            <button type="reset" className="ui-icon">
              <ClearIcon />
            </button>
          </Tooltip>

          <Tooltip text="Add">
            <button type="submit" className="ui-icon">
              <AddIcon />
            </button>
          </Tooltip>
        </div>
