...
export default function PaginationBar(props) {
  return (
    <div className="pagination-ui">
      <button
        className="ui-icon"
        disabled={!props.checkIfOnFirstPage ? "" : 1}
      ...
      <button
        className="ui-icon"
        disabled={props.checkIfPreviousPage ? "" : 1}
      ...
      <div>
        <div>
          Page {props.pageOffset} / {props.pageCount}
        </div>
      </div>
      <button
        className="ui-icon"
        disabled={props.checkIfNextPage ? "" : 1}
      ...
      <button
        className="ui-icon"
        disabled={!props.checkIfOnLastPage ? "" : 1}
